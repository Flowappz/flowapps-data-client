...
export const CUSTOM_SCRIPTS_CONFIG: {
  ...
  [CUSTOM_SCRIPTS_NAME.FORM_FIELDS_PRO_CDN_SCRIPT]: {
    ...
    hosted: true,
    hostedLocation:
      "https://cdn.jsdelivr.net/gh/rabbykhairul/jsdeliver-cdn-scripts@v4.2.0/form-fields-cdn.js",
    integrityHash:
      "sha384-C1hVkSXYCcCRHhnjMzNh1a5P8OZoHGFYUshRh+46t7nH2UeFKa8u3eIj+agDeVZU",
  },
